...
export type Project = {
  ...
  demoLabel?: Localized;
  repoUrl?: string;
  /** Icon app vuông đặt trong /public, ví dụ "/app-icons/app.png". */
  icon?: string;
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    icon: "/app-icons/wifi-nearby.png",
    highlights: {
      vi: [
  ...
  },
  {
    ...
    icon: "/app-icons/shimeji-pet.jpg",
    highlights: {
      vi: [
  ...
  },
  {
    ...
    icon: "/app-icons/bluetooth-device-finder.png",
    highlights: {
      vi: [
